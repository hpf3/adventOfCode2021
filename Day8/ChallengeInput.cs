...
namespace Day8
{
    ...
    {
        public static string[][][] Demo { get => SplitInput(@"be cfbegad cbdgef fgaecd cgeb fdcge agebfd fecdb fabcd edb | fdgacbe cefdb cefbgd gcbe
...
gcafb gcf dcaebfg ecagb gf abcdeg gaef cafbge fdbac fegbdc | fgae cfgab fg bagce"); }
        ...
        {
            get => SplitInput(@"acedgfb cdfbe gcdfa fbcad dab cefabd cdfgeb eafb cagedb ab | cdfeb fcadb cdfeb cdbaf");
        }


        public static string[][][] Data { get => SplitInput(
...
agedc cf cdeagf agcf cbefda fdcge cdgaeb bedgf dcf gbcaefd | gdefb fc egcad abecgd"
        ...
        private static string[][][] SplitInput(string input)
        {
            ...
            for (int i = 0; i < rows.Length; i++)
            {
                ...
                line[0] = tmp[0].Split(' ', StringSplitOptions.RemoveEmptyEntries);
                line[1] = tmp[1].Split(' ', StringSplitOptions.RemoveEmptyEntries);
                result[i] = line;
            }
            return result;
        }
